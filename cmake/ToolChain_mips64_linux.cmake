...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wa,-mips64r2 -mabi=64 -march=gs464e" CACHE STRING "cflags")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wa,-mips64r2 -mabi=64 -march=gs464e" CACHE STRING "c++flags")
